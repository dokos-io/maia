...
def codifications(country=None):
	records = [
		...
		{'doctype': 'Codification', 'codification': 'CCP', 'basic_price': 46, 'billing_price': 46, 'codification_name': 'CCP', 'codification_description': 'Première consultation de contraception et de prévention des jeunes filles entre 15 et 18 ans'},
