	...
	records = [
		...
		{'doctype': 'Assessment Group', 'assessment_group_name': _('All Assessment Groups'),
			'is_group': 1, 'parent_assessment_group': ''},
                ...
                #Lab Exam Types
                {'doctype': "Lab Exam Type", 'exam-type': _("Antiglobulin Testing")},
                {'doctype': "Lab Exam Type", 'exam-type': _("First Determination of ABO- and Rh-groups")},
                {'doctype': "Lab Exam Type", 'exam-type': _("Second Determination of ABO- and Rh-groups")},
                {'doctype': "Lab Exam Type", 'exam-type': _("Complete Blood")},
                {'doctype': "Lab Exam Type", 'exam-type': _("Blood Platelets")},
                {'doctype': "Lab Exam Type", 'exam-type': _("Ferritin")},
                {'doctype': "Lab Exam Type", 'exam-type': _("TP, TCA")},
                {'doctype': "Lab Exam Type", 'exam-type': _("Fibrinogen")},
                {'doctype': "Lab Exam Type", 'exam-type': _("TSH")},
                {'doctype': "Lab Exam Type", 'exam-type': _("T3, T4")},
                {'doctype': "Lab Exam Type", 'exam-type': _("Fasting Blood Glucose")},
                {'doctype': "Lab Exam Type", 'exam-type': _("HGPO 75g")},
                {'doctype': "Lab Exam Type", 'exam-type': _("Total Cholesterol")},
                {'doctype': "Lab Exam Type", 'exam-type': _("Triglycerides")},
                {'doctype': "Lab Exam Type", 'exam-type': _("Glucosuria and Albuminuria")},
                {'doctype': "Lab Exam Type", 'exam-type': _("HCG Assay")},
                {'doctype': "Lab Exam Type", 'exam-type': _("Albuminuria")},
                {'doctype': "Lab Exam Type", 'exam-type': _("ECBU +/- Antibiogram")},
                {'doctype': "Lab Exam Type", 'exam-type': _("Proteinuria over 24h")},
                {'doctype': "Lab Exam Type", 'exam-type': _("Vaginal Swab +/- Antibiogram")},
                {'doctype': "Lab Exam Type", 'exam-type': _("Endocervix Swab")},
                {'doctype': "Lab Exam Type", 'exam-type': _("Toxoplasmosis Serology")},
                {'doctype': "Lab Exam Type", 'exam-type': _("Rubella Serology")},
                {'doctype': "Lab Exam Type", 'exam-type': _("TPHA-VRDL Serology")},
                {'doctype': "Lab Exam Type", 'exam-type': _("HIV Serology")},
                {'doctype': "Lab Exam Type", 'exam-type': _("HBs Antigen")},
                {'doctype': "Lab Exam Type", 'exam-type': _("Hp C Serology")},
                {'doctype': "Lab Exam Type", 'exam-type': _("CMV Serology")},
                {'doctype': "Lab Exam Type", 'exam-type': _("Chickenpox Serology")},
                {'doctype': "Lab Exam Type", 'exam-type': _("Ionograms")},
                {'doctype': "Lab Exam Type", 'exam-type': _("ASAT-ALAT")},
                {'doctype': "Lab Exam Type", 'exam-type': _("LDH")},
                {'doctype': "Lab Exam Type", 'exam-type': _("Creatinemia")},
                {'doctype': "Lab Exam Type", 'exam-type': _("Haptoglobin")},
                {'doctype': "Lab Exam Type", 'exam-type': _("Bile Salts")},
                {'doctype': "Lab Exam Type", 'exam-type': _("Total and Conjugated Bilirubin")},
                {'doctype': "Lab Exam Type", 'exam-type': _("Gamma-GT")},
                {'doctype': "Lab Exam Type", 'exam-type': _("PAL")},
                {'doctype': "Lab Exam Type", 'exam-type': _("CRP")},
                {'doctype': "Lab Exam Type", 'exam-type': _("HDL Cholesterol")},
                {'doctype': "Lab Exam Type", 'exam-type': _("LDL Cholesterol")},
                {'doctype': "Lab Exam Type", 'exam-type': _("PAPP-A and Free Beta-HCG ")},
