...
def get_data(patient_record):
	...
	if pregnancydata and (pregnancydata['expected_term'] is not None or pregnancydata['beginning_of_pregnancy'] is not None):
	...
	if labexamsdata and labexamsdata['exam_results'] is not None:
